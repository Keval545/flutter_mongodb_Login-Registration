...
class MongoDBService {
  ...
  Future<void> connect() async {
    final String dbUrl = 'mongodb+srv://keval545:QPzH37VGHH8V6h4c@mydarabase.pdwvsuj.mongodb.net/?retryWrites=true&w=majority'; // Replace with your MongoDB connection URL
